...
<br>
This equation is a linear representation of what the fare charge should be, according to the [TLC site](https://www1.nyc.gov/site/tlc/passengers/taxi-fare.page). With the data, we estimated $X_{slow+stop}$ by maximizing $X_{fast}$. This minimizes the congestion variable to only represent the amount of time a taxi is stopped.
