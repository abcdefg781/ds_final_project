...
The first four graphs show the frequency of rides into Manhattan from each borough (other than Staten Island) throughout the entire day. The stacked histogram allows us to see how many cab rides came from each type of taxi. We were interested in seeing how these numbers might have changed for Valentine's Day dinner, though, so we created a second set of four graphs just between the hours of 6-9 PM to see when people were leaving for their Valentine's Day plans.
...
Between 6 to 9 PM, there were a lot of pickups by cab in Manhattan to other destinations in Manhattan. All three hours were pretty busy, with 8 to 9 PM being slightly less busy, but each of these hours still had over 3000 pickups.
