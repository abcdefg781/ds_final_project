...
The downloaded data from the TLC contained over a million observations, so we decided to limit the amount of data for our analysis. First, we filtered our data to only contain taxis going into Manhattan. Our logic behind this was that this would reflect the general habits of New Yorkers, as most of the main attractions of New York City reside in the borough of Manhattan. 
