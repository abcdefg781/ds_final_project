...
You might also be interested in the neighborhoods in Manhattan with the highest average taxi fares (which means they are popular!) If so, you can check it out in the Shiny app!
